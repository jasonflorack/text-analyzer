...
class Analyzer:
    ...
    #     p = PorterStemmer()
    #     p.stem_words(self.filtered_words)
    ...
    def display_common_terms(self):
        ...
        # print ({k: v for k, v in sorted(self.frequency.items(), key=lambda item: item[1])})
...
#             infile.close()
    ...
    def stem_words(self, words):
        stemmed_words = []
        for word in words:
            stemmed_words.append(self.stem(word, 0, len(word)-1))
...
p = PorterStemmer()
a.root_words = p.stem_words(a.filtered_words)
# print(a.root_words)

a.compute_frequency()
# print(a.frequency)
a.display_common_terms()
# print(a.common_terms)
